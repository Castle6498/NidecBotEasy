...
public class NidecBrushlessThree extends SendableBase implements SpeedController, MotorSafety, Sendable {
   ...
   *              
   */
  public NidecBrushlessThree(final int pwmEnableChannel, 
		  final int dioChannel, final int pwmDirectionChannel, 
		  final int encoderAChannel, final int encoderBChannel) {
